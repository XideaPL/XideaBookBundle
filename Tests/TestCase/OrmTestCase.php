...
namespace Xidea\Bundle\BookBundle\Tests\TestCase;
...
abstract class OrmTestCase extends DoctrineOrmTestCase
{
    ...
    protected function setUp()
    {
        ...
        $metadataDriver = new AnnotationDriver(
            ...
            'Xidea\\Bundle\\BookBundle\\Entity'
        );
        ...
        // allows you to use the AcmeBookBundle:Book syntax
        $this->_em->getConfiguration()->setEntityNamespaces(array(
            'AcmeBookBundle' => 'Acme\\BookBundle\\Entity'
        ));
    }
}